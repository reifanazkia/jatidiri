...
@section('content')
    <div class="max-w-full bg-white mx-auto p-[32px] rounded-[24px] shadow-sm">
        <h2 class="text-xl font-semibold mb-6">Add Benefit</h2>

        <form action="{{ route('benefits.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="mt-6">
                            <div class="relative">
                                <label for="facility_id"
                                    class="block mb-2 text-sm font-medium text-gray-700">Assesment</label>
                                <select name="facility_id" id="facility_id" required
                                    class="w-full py-2.5 pl-4 pr-10 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white">
                ...
                <div class="col-start-3">
                    <label for="image" class="block mb-2 text-sm font-medium text-gray-700">Upload Image (Max: 2MB)</label>
                    <div id="dropzone"
                        class="flex flex-col justify-center items-center border-2 border-gray-300 rounded-lg h-56 text-gray-500 text-sm text-center cursor-pointer w-full">
