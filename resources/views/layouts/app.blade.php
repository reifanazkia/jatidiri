            ...
            <ul class="mb-60">
                ...
                <li class="mt-5">
                    <a href="{{ route('dashboard') }}"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200
                {{ request()->is('dashboard') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->is('dashboard') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->is('dashboard') ? 'text-white' : 'text-black' }}">
                                <path
                ...
                <li class="mt-5">
                    ...
                    <button type="button" onclick="document.getElementById('blogDropdown').classList.toggle('hidden')"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200 w-full
                {{ request()->routeIs('posts.*') || request()->routeIs('agenda.*') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->routeIs('posts.*') || request()->routeIs('agenda.*') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->routeIs('posts.*') || request()->routeIs('agenda.*') ? 'text-white' : 'text-black' }}">
                                <path fill-rule="evenodd"
                        ...
                        <!-- Chevron -->
                        <svg class="w-4 h-4 transition group-hover:text-white transform transition-transform
                    {{ request()->routeIs('posts.*') || request()->routeIs('agenda.*') ? 'text-white' : 'text-black' }}"
                    ...
                    <div id="blogDropdown" class="hidden ml-4 mt-3 space-y-3">
                        <!-- Submenu: Posts -->
                        <div
                            class="rounded-xl shadow-md px-4 py-3 transition hover:scale-105 group
                    {{ request()->routeIs('posts.*') ? 'bg-[#3030F8] text-white' : 'bg-slate-700 text-gray-300 hover:text-white' }}">
                            <a href="{{ route('posts.index') }}" class="block text-[16px] font-medium">
                                • Posts
                            </a>
                        </div>
                        ...
                        <div
                            class="rounded-xl shadow-md px-4 py-3 transition hover:scale-105 group
                    {{ request()->routeIs('agenda.*') ? 'bg-[#3030F8] text-white' : 'bg-slate-700 text-gray-300 hover:text-white' }}">
                            <a href="{{ route('agenda.index') }}" class="block text-[16px] font-medium">
                                • Agenda
                            </a>
                        </div>
                    </div>
                ...
                <li class="mt-5">
                    <a href="{{ route('service.index') }}"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200
                {{ request()->is('services') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->is('services') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->is('services') ? 'text-white' : 'text-black' }}">
                                <path fill-rule="evenodd"
                ...
                <li class="mt-5">
                    <a href="#"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200
                {{ request()->is('profile') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->is('profile') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->is('profile') ? 'text-white' : 'text-black' }}">
                                <path fill-rule="evenodd"
                ...
                <li class="mt-5">
                    <a href="#"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200
                {{ request()->is('features') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->is('features') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->is('features') ? 'text-white' : 'text-black' }}">
                                <path fill-rule="evenodd"
                ...
                <li class="mt-5">
                    <a href="#"
                        class="group flex items-center gap-3 px-5 py-3 rounded-2xl shadow-md font-semibold hover:scale-110 transition duration-200
                {{ request()->is('setting') ? 'bg-[#3030F8] text-white' : 'bg-white text-black hover:bg-[#3030F8]' }}">

                        <span
                            class="flex gap-2 text-[15px] leading-none transition group-hover:text-white
                    {{ request()->is('setting') ? 'text-white' : 'text-black' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5 transition group-hover:text-white
                        {{ request()->is('setting') ? 'text-white' : 'text-black' }}">
                                <path fill-rule="evenodd"
