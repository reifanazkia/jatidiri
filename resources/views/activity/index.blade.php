...
@section('content')
        ...
        <div class="bg-white rounded-[24px] shadow-md p-6">
            ...
            <div class="flex gap-4 items-center mb-3 relative">
                ...
                <div
                    ...
                    <a href="{{ route('activity.create') }}" id="createButton"
                        ...
                        @foreach ($data as $item)
                            <tr class="h-[36px]">
                                ...
                                <td class="px-2 py-2 flex border border-gray-300">
                                    <a href="{{ route('activity.edit', $item->id) }}" id="editButton-{{ $item->id }}"
    ...
    <script>
        ...
        // SweetAlert for edit buttons (fixed version)
