...
@section('page_title', 'How Services')

@section('content')
    <div class="max-w-full mx-auto">
        <div class="bg-white rounded-[24px] p-[32px]">
            <h2 class="text-[24px] font-semibold mb-[32px] text-gray-800">Add</h2>

            <form action="{{ route('how.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-left mt-6">
                    <button type="submit"
                        class="bg-[#8989FC] hover:bg-blue-700 text-white font-semibold cursor-pointer px-6 py-3 rounded-full transition">
                        Save
                    </button>
                </div>
            </form>
