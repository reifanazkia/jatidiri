        ...
        <div class="bg-white rounded-[24px] shadow-md p-6">
            ...
            <div class="flex gap-4 items-center mb-3 relative">
                ...
                <div
                    ...
                    <a href="{{ route('how.create') }}" id="addNewButton"
                        ...
                        @foreach ($data as $item)
                            <tr class="h-[36px]">
                                ...
                                <td class="px-2 py-2 flex border border-gray-300">
                                    <a href="{{ route('how.edit', $item->id) }}" id="editButton{{ $item->id }}"
                                    ...
                                    <form action="{{ route('how.destroy', $item->id) }}" method="POST" class="inline"
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        didOpen: () => {
                            ...
                            // Submit delete request - UPDATED URL TO MATCH YOUR ROUTE
