...
@section('content')
    <div class="max-w-full mx-auto">
        <div class="bg-white rounded-[24px] shadow-md p-6">
            ...
            <!-- Header Action -->
            <div class="flex gap-4 items-center mb-2 relative">
                <!-- Select Service -->
                <div class="w-[180px]">
                    <div class="relative">
                ...
                <div
                    ...
                    <a href="{{ route('why.create') }}" id="addNewButton"
            ...
            <div class="overflow-x-auto">
                <table class="table-auto mt-6 border border-gray-300 w-full text-sm">
                    <thead>
                        ...
                        @foreach ($why as $item)
                            <tr class="h-[36px]">
                                ...
                                <td class="px-2 py-2 flex border border-gray-300">
                                    ...
                                    <!-- Delete -->
                                    <form method="POST" action="{{ route('why.destroy', $item->id) }}"
                                        class="inline delete-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
                                            class="delete-btn flex items-center gap-2 bg-red-500 text-white px-3 py-1 rounded text-xs"
                                            data-id="{{ $item->id }}">
                                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="-3 -2 24 24">
                                                <path fill="currentColor" d="M6 2V1a1 1 0 0 1 1-1h4a1 1 0 0
                                                         1 1 1v1h4a2 2 0 0 1 2 2v1a2 2
                                                         0 0 1-2 2h-.133l-.68 10.2a3 3
                                                         0 0 1-2.993 2.8H5.826a3 3 0
                                                         0 1-2.993-2.796L2.137 7H2a2
                                                         2 0 0 1-2-2V4a2 2 0 0
                                                         1 2-2zm10 2H2v1h14zM4.141 7l.687
                                                         10.068a1 1 0 0 0 .998.932h6.368a1
                                                         1 0 0 0 .998-.934L13.862 7zM7
                                                         8a1 1 0 0 1 1 1v7a1 1 0 0
                                                         1-2 0V9a1 1 0 0 1 1-1m4
                                                         0a1 1 0 0 1 1 1v7a1 1 0 0
                                                         1-2 0V9a1 1 0 0 1 1-1" />
                                            </svg>
                                            Delete
                                        </button>
                                    </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.delete-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const itemName = this.closest('tr').querySelector('td:nth-child(3)')
                    .textContent;
                    Swal.fire({
                        title: 'Are you sure?',
