...
@section('content')
    <div class="max-w-full min-h-screen mx-auto" x-data="{
        ...
        <div class="bg-white rounded-[24px] shadow-md p-[32px]">
            <h2 class="text-[20px] font-semibold mb-8">Add</h2>
            ...
            <form action="{{ route('program.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div x-show="step === 1" x-transition>
                            ...
                            <div class="flex justify-center items-center w-full h-60 border-2 border-dashed border-gray-300 rounded-xl bg-white cursor-pointer"
                                ...
                                <template x-if="formData.image1">
                                    <div class="relative w-full h-full">
                                        <img :src="formData.image1 instanceof File ? URL.createObjectURL(formData
                    ...
                    <div class="grid grid-cols-6 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <select name="outream_id" x-model="formData.outeam_id"
                                class="w-full h-[50px] border border-gray-300 rounded-sm px-4 py-2 text-sm outline-none focus:ring-1 focus:ring-blue-500">
                                @foreach($outreams as $outream)
                                    <option value="{{ $outream->id }}">{{ $outream->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description1" id="description1" rows="3"
                ...
                <div x-show="step === 2" x-transition>
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-8 text-sm text-gray-700">
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="Kabid SMK Disdik Jabar"
                                x-model="formData.supporting" class="accent-[#9A8FFF]">
                            Kabid SMK Disdik Jabar
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="Walikota Cimahi"
                                x-model="formData.supporting" class="accent-[#9A8FFF]">
                            Walikota Cimahi
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="Rektor IKIP Siliwangi"
                                x-model="formData.supporting" class="accent-[#9A8FFF]">
                            Rektor IKIP Siliwangi
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="ketua HIMPSI"
                                x-model="formData.supporting" class="accent-[#9A8FFF]">
                            ketua HIMPSI
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="Ketua DPRD Kota Cimahi"
                                x-model="formData.supporting" class="accent-[#9A8FFF]">
                            Ketua DPRD Kota Cimahi
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="supporting[]" value="Dewan Pakar" x-model="formData.supporting"
                                class="accent-[#9A8FFF]">
                            Dewan Pakar
                        </label>
                    </div>
                        ...
                        <div class="w-full">
                            <div class="mb-6">
                                ...
                                <input type="text" name="title2" placeholder="Title Section 2"
                                    x-model="formData.title2"
                                    class="w-full border border-gray-300 rounded-sm px-4 py-2 text-sm outline-none focus:ring-1 focus:ring-blue-500">
                            </div>

                             <!-- Description -->
                <div class="mt-4">
                    <label class="block text-sm font-medium mb-1">Description 2 </label>
                    <textarea name="description2" id="description2" rows="3"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring focus:ring-blue-200"
                        placeholder="Enter description"></textarea>
                </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex justify-center items-center w-full h-60 border-2 border-dashed border-gray-300 rounded-xl bg-white cursor-pointer"
                                ...
                                <template x-if="formData.image2">
                                    <div class="relative w-full h-full">
                                        <img :src="formData.image2 instanceof File ? URL.createObjectURL(formData
                                ...
                                <input type="file" name="image2" x-ref="image2"
                                    @change="formData.image2 = $event.target.files[0]" accept="image/*"
                                    class="hidden">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <label class="block text-sm font-medium mb-1">Description </label>
                    <textarea name="description3" id="description3" rows="3"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring focus:ring-blue-200"
                        placeholder="Enter description"></textarea>
                </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex justify-center items-center w-full h-60 border-2 border-dashed border-gray-300 rounded-xl bg-white cursor-pointer"
                                ...
                                <template x-if="formData.image3">
                                    <div class="relative w-full h-full">
                                        <img :src="formData.image3 instanceof File ? URL.createObjectURL(formData
                                ...
                                <input type="file" name="image3" x-ref="image3"
                                    @change="formData.image3 = $event.target.files[0]" accept="image/*"
                                    class="hidden">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <label class="block text-sm font-medium mb-1">Description </label>
                    <textarea name="description4" id="description4" rows="3"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring focus:ring-blue-200"
                        placeholder="Enter description"></textarea>
                </div>
                        </div>
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="flex justify-center items-center w-full h-60 border-2 border-dashed border-gray-300 rounded-xl bg-white cursor-pointer"
                                ...
                                <template x-if="formData.image4">
                                    <div class="relative w-full h-full">
                                        <img :src="formData.image4 instanceof File ? URL.createObjectURL(formData
                                ...
                                <input type="file" name="image4" x-ref="image4"
                                    @change="formData.image4 = $event.target.files[0]" accept="image/*"
                                    class="hidden">
                            </div>
                        </div>
                    </div>
