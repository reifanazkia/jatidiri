...
@section('content')
        ...
        <div class="bg-white rounded-[24px] shadow-md p-6">
            ...
            <div class="flex gap-4 items-center mb-3 relative">
                ...
                <div
                    ...
                    <a href="{{ route('masalah.create') }}" id="addNewButton"
                        ...
                        @foreach ($data as $item)
                            <tr class="h-[36px]">
                                ...
                                <td class="px-2 py-2 flex border border-gray-300">
                                    <a href="{{ route('masalah.edit', $item->id) }}" id="editButton{{ $item->id }}"
                                    ...
                                    <form action="{{ route('masalah.destroy', $item->id) }}" method="POST" class="inline"
    ...
    <script>
        ...
        document.getElementById('addNewButton').addEventListener('click', function(e) {
            ...
            Swal.fire({
                title: 'Loading...',
                html: 'Preparing the form for you',
